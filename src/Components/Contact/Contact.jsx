...
const Contact = () => {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "9c77895d-8a39-4f5d-bfd8-a97a5d583da2");
    ...
    <div className='contact'>
        <div className="contact-col">
            ...
            <p>Feel free to reach out through contact form or
                ...
                <ul>
                    <li><img src={mail_icon} alt="" />abc@example.com</li>
                    <li><img src={phone_icon} alt="" />+1 900-000-0000</li>
                    <li><img src={location_icon} alt="" />Rose Villa, Link Road<br></br>Near Stn, California</li>
                </ul>
        </div>
